package com.wansu.library.weight;
...
public class SwitchButton extends View implements Checkable {
     ...
     * 动画状态：
     */
    private final int ANIMATE_STATE_NONE = 0;            // 静止
    private final int ANIMATE_STATE_PENDING_DRAG = 1;    // 进入拖动
    private final int ANIMATE_STATE_DRAGING = 2;         // 处于拖动
    private final int ANIMATE_STATE_PENDING_RESET = 3;   // 拖动-复位
    private final int ANIMATE_STATE_PENDING_SETTLE = 4;  // 拖动-切换
    private final int ANIMATE_STATE_SWITCH = 5;          // 点击切换
